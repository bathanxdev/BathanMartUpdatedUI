...
class AdminWarehousesScreen extends StatefulWidget {
  ...
  //@override State<AdminWarehousesScreen> createState() => _AdminLocationsScreenState();
  @override State<AdminWarehousesScreen> createState() => _AdminWarehousesScreenState();
}
